...
@section('css')
<title class="capi">{{ ucwords(trans('app.fags'))}}</title>
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li><strong class="capi">{{ trans('app.fags')}}</strong></li>
          </ul>
        </div>
      </div>
    </div>
   ...
   <div class="row">
       <div class="about-page">
          <div class="col-xs-12 col-sm-6">
            <h1 class="capi">{{ trans('app.most_asked_questions')}}
            </h1>
            <p>Sual və cavablandırlamaları əlavə ediləcəkdir.</p>
          </div>
          <div class="col-xs-12 col-sm-6">
            <div class="single-img-add sidebar-add-slider">
              <div id="carousel-example-generic" class="carousel slide">
                <div class="carousel-inner" role="listbox">
                  <div class="item active"> <img src="{{ asset('images/faq_image.jpg')}}"> </div>
                </div>
              </div>
            </div>
          </div>
